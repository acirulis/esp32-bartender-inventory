...
{
    bool doSetup = false;
    // untested changes in setup - first step is "enter setup" command.
    byte setupBarcode[] = {0x7E, 0x3C, 0x53, 0x4F, 0x48, 0x3E, 0x30, 0x30, 0x30, 0x30, 0x40, 0x53, 0x45, 0x54, 0x55, 0x50, 0x45, 0x31, 0x2A, 0x3B, 0x3C, 0x45, 0x54, 0x58, 0x3E};
    
    Serial2.write(setupBarcode, sizeof(setupBarcode));
